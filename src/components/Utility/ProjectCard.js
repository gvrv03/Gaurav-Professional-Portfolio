...
const ProjectCard = ({ project }) => {
  return (
    <div
      className="bg-gray-800/50 flex-col flex justify-between gap-5 backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-700/50 shadow-xl hover:shadow-purple-500/20 transition-all duration-300 hover:transform hover:-translate-y-2 group"
    >
      ...
      <div className="p-6  flex-col gap-5 flex">
